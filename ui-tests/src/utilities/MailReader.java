...
public class MailReader {
	...
	public void printEnvelope(Message message) throws Exception
	{
		...
		if(subject.equals(expectedSubject))
		{
			...
			activationUrlCode = searchUrl.search(content, expectedSubject);
			//getContent(message);
		}
	...
	public void dumpPart(Part p) throws Exception
	{
		...
		String filepath = currentUsersDir+"\\out\\out.txt";
	...
	public static void main(String args[])
	{
		...
		String url = mr.FetchMails("imap.gmail.com","qa.gauravsingh01@gmail.com", "ronnit1029", "Please verify your email address");
